...
export function RecentSearches({ onSearchClick }: RecentSearchesProps) {
  const [recent, setRecent] = React.useState<RecentSearch[]>(MOCK_RECENT_SEARCHES);
      ...
      <div className="space-y-2">
        {recent.map((search) => (
          <div
            ...
            className="flex w-full cursor-pointer items-center justify-between rounded-lg px-3 py-2 text-sm hover:bg-muted transition-colors"
          >
